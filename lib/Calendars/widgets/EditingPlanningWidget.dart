import 'package:all_uni_dev/Calendars/widgets/TagChoicePlanningWidget.dart';
...
class _EditingPlanningWidgetState extends State<EditingPlanningWidget> {
  ...
  void initState() {
    ...
    if (widget.lesson == null) {
      ...
      final LocalLesson lesson = widget.lesson!;
      fromDate = DateTime.parse(lesson.HeureDebut.toString());
      toDate = DateTime.parse(lesson.HeureFin.toString());
      LocalizationController.text = lesson.NomCours!;
