import 'package:all_uni_dev/Calendars/widgets/TagChoiceDeadlineWidget.dart';
...
class _EditingDeadlineWidgetState extends State<EditingDeadlineWidget> {
  ...
  void initState() {
    ...
    if (widget.lesson == null) {
      ...
      final deadline = widget.lesson!;
      deadlineDate = DateTime.parse(deadline.HeureDebut.toString());
      tagsNames = deadline.Tags!;
    }
  }
