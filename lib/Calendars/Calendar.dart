...
class Calendar extends StatefulWidget {
  String currentView;
  int CalendarFormatIndex;
  List<CalendarAppointment> lessons;
  List<String> promotions;

  Calendar(
      this.currentView, this.CalendarFormatIndex, this.promotions, this.lessons,
      {super.key});
...
class _CalendarState extends State<Calendar> {
      ...
      return Container(
        ...
        child: Row(
          children: [
            ...
            Flexible(
              flex: 1,
              child: (appointment.appointmentType != "Deadline")
                  ? Column(
                      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                      children: [
                        Text(
  ...
  Widget appointmentBuilder(
    ...
    CalendarAppointment lesson = details.appointments.first;
    if (CalendarFormatIndex == 0 || CalendarFormatIndex == 3) {
          ...
          children: [
            Flexible(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    "   ${DateFormat.Hm().format(lesson.fromDate)}   ",
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      fontSize: details.bounds.height * 0.25,
                      fontWeight: FontWeight.w300,
                  ...
                  Text(
                    "   ${DateFormat.Hm().format(lesson.toDate)}   ",
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      fontSize: details.bounds.height * 0.25,
                      fontWeight: FontWeight.w300,
            ...
            Flexible(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    "${DateFormat.Hm().format(lesson.toDate)} - ${DateFormat.Hm().format(lesson.toDate)}",
                    overflow: TextOverflow.ellipsis,
                    style: const TextStyle(fontSize: 12),
                  ),
                ],
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SfCalendar(
        ...
        dataSource: CalendarAppointmentsDataSource(
          widget.lessons,
        ),
        initialSelectedDate: DateTime.now().add(const Duration(days: -365)),
