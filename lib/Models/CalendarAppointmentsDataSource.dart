...
class CalendarAppointmentsDataSource extends CalendarDataSource {
  ...
  @override
  String getTitle(int index) => getAppointment(index).title!;

  @override
  String getDescription(int index) => getAppointment(index).description!;

  @override
  DateTime getStartTime(int index) => getAppointment(index).fromDate!;

  @override
  DateTime getEndTime(int index) => getAppointment(index).toDate!;
}
...
//       appointments![index] as CalendarAppointment;
//
//   String getAppointmentType(int index) => getAppointment(index).appointmentType;
//
